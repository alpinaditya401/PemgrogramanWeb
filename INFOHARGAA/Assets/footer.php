<?php
/**
 * Assets/footer.php — shared public footer
 */
?>
  ...
  <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
      ...
      <div>
        <div class="flex items-center gap-2 mb-3">
          ...
          <span class="font-display font-bold text-[var(--text-primary)]">
            InfoHarga<span class="text-brand-500">Komoditi</span>
          </span>
        </div>
        <p class="text-sm text-[var(--text-muted)] leading-relaxed max-w-xs">
          Platform transparansi harga komoditas pangan Indonesia. Data real-time dari kontributor lapangan di 38 provinsi.
        </p>
      ...
      <div>
        ...
        <div class="mt-5 p-3.5 rounded-xl bg-brand-500/8 border border-brand-500/15">
          <p class="text-xs text-[var(--text-secondary)] leading-relaxed">
            ...
            Bantu kami menyediakan data harga yang akurat untuk seluruh Indonesia.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="pt-6 border-t border-[var(--border)] flex flex-col sm:flex-row justify-between items-center gap-3">
      <p class="text-xs text-[var(--text-muted)]">
        &copy; <?= date('Y') ?> InfoHarga Komoditi. Seluruh hak cipta dilindungi.
      </p>
      <p class="text-xs text-[var(--text-muted)]">
        Data bersumber dari kontributor lapangan &bull; Referensi: <a href="https://infoharga.bappebti.go.id" target="_blank" rel="noopener" class="text-brand-500 hover:underline">Bappebti</a>
      </p>
    </div>
  </div>
</footer>
